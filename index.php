...
<header class="header">
    ...
    <nav class="navbar">
        ...
        <a href="#plan">Paquetes</a>
        <a href="#contact">contacto</a>
    </nav>

    <div class="icons">
        <div class="fas fa-bars" id="menu-btn"></div>
        <a class="fa fa-address-book" href="register.php">Signup</a>
...
<div class="dog-food">
    ...
    <div class="content">
        ...
        <a href="login.php"> <img src="image/See_more.png" alt=""> </a>
    </div>
...
<div class="cat-food">
    ...
    <div class="content">
        ...
        <a href="login.php"> <img src="image/pez.png" alt=""> </a>
    </div>
...
<section class="shop" id="shop">
    ...
    <center><a href="login.php"  class="btn">Mas Productos</a></center>
...
<section class="services" id="services">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <a href="login.php" class="btn">Agendar</a>
        </div>
...
<section class="plan" id="plan">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <a href="login.php" class="btn"> Elegir Plan </a>
        </div>
